node{
   ...
   def tomcatWeb = 'C:\\Users\\heman\\Tomcat\\apache-tomcat-9.0.33-windows-x64\\webapps'
...
'''
   ...
   stage('Deploy to Tomcat'){
     bat "copy target\\JenkinsTomcatPipeline.war \"${tomcatWeb}\\JenkinsTomcatPipeline.war\""
   }
